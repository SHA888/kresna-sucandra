        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="h-14 mb-8 animate-fade-in opacity-0 animate-delay-200">
            <div className="relative text-xl sm:text-2xl text-center">
              <span className="text-emerald-600 font-medium inline-block min-w-52 transition-all duration-300" key={currentRoleIndex}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in opacity-0 animate-delay-400">
            <a href="#about" className="px-6 py-3 rounded-lg bg-primary text-white font-medium transition-all hover:bg-primary/90 shadow-sm hover:shadow">
              Learn More
            </a>
            <a href="#contact" className="px-6 py-3 rounded-lg border border-foreground/10 bg-white/50 hover:bg-white font-medium transition-all">
              Get in Touch
            </a>
          </div>
        </div>
