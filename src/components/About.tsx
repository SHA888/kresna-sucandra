        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed">Beyond my clinical practice, I'm a tech co-founder involved in multiple startups, UJAMI Journal Manager, and an avid creator in AI, Web3, and Cyber Security.</p>
              <p className="text-lg leading-relaxed">
